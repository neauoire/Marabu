...
app.on('ready', () => 
{
  app.win = new BrowserWindow({width: 890, height: 540, backgroundColor:"#000", minWidth: 587, minHeight: 540, frame:false, autoHideMenuBar: true, icon: __dirname + '/icon.ico'})
